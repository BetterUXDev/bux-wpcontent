...
if(isset($_POST['submitted']) && isset($_POST['post_nonce_field']) && wp_verify_nonce($_POST['post_nonce_field'], 'post_nonce')) {
	...
	if($post_id)
	{
		...
		update_post_meta($post_id, 'buxcs_custom_two', esc_attr(strip_tags($_POST['customMetaTwo'])));
	...
	<main id="insert">
		...
		<form action="" id="primaryPostForm" method="POST">
			...
			<fieldset>
				...
				<textarea type="text" name="buxcs_title_field" id="buxcs_title_field"> 
		
					<?php if(isset($_POST['buxcs_title_field'])) { if(function_exists('stripslashes')) { echo stripslashes($_POST['buxcs_title_field']); } else { echo $_POST['buxcs_title_field']; } } ?>
			...
			<fieldset>
				...
				<textarea type="text" name="customMetaTwo" id="buxcs_title_field"> 
